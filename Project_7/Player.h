...
namespace cs31
{
    ...
    public:
        ...
        // randomly roll this player's dice
        void roll();
        // force a particular outcome by cheating
        ...
        // called to indicate that a certain spot has been rolled
        void rolled(int spot);
        //determine what value is needed next to move forward in the game
